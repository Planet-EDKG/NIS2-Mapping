...
geändert in 2025, weiter als GV.OC-04.2 (IMPORTANT)
...
The goal of this control is to ensure that essential operations are protected by clearly defined and tested security
measures, and that these measures remain effective and up to date as risks evolve.
...
- Document security and operational requirements, including regulatory and industry-specific needs (e.g.
CyFun®, ISO/IEC 27001, IEC 62443).
- Validation & Approval
