...
geändert in 2025, weiter als PR.AA-06.3

# Critical zones shall have additional physical access controls beyond those applied to general facilities.

## Implementation guidance
The goal of this control is to reduce the risk of unauthorised physical access to areas essential for operational
continuity, data integrity, and personnel and equipment safety by applying stricter access measures than those
used in general facility areas.
