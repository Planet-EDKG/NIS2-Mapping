...
status: "offen"
owner: ""
mapping_to: ["000 NICE Framework v2.2.0", "DE.CM-02", "GV.SC-08", "ID.AM-01", "ID.AM-02", "ID.AM-03", "ID.AM-04", "ID.AM-05", "ID.AM-07", "ID.AM-08", "ID.IM-03", "PR.AA-01", "PR.AA-02", "PR.AA-03", "PR.AA-04", "PR.AA-05", "PR.AA-06", "PR.DS-01", "PR.DS-02", "PR.DS-10", "PR.DS-11", "PR.PS-01", "PR.PS-02", "PR.PS-03", "PR.PS-04", "PR.PS-05", "PR.PS-06", "RC.CO-03", "RC.RP-01", "RC.RP-02", "RC.RP-03", "RC.RP-04", "RC.RP-05", "RC.RP-06", "RS.MA-01", "RS.MA-02", "RS.MA-03", "RS.MA-04", "RS.MA-05", "RS.MI-01", "RS.MI-02"]
id: "IO-WRL-005"
opm: "451"
...
**Kategorie:** IMPLEMENTATION and OPERATION
**OPM Code:** 451
...
- [[NIST/DE.CM-02|DE.CM-02]]: The physical environment is monitored to find potentially adverse events
- [[NIST/GV.SC-08|GV.SC-08]]: Relevant suppliers and other third parties are included in incident planning, re…
- [[NIST/ID.AM-01|ID.AM-01]]: Inventories of hardware managed by the organization are maintained
- [[NIST/ID.AM-02|ID.AM-02]]: Inventories of software, services, and systems managed by the organization are m…
- [[NIST/ID.AM-03|ID.AM-03]]: Representations of the organization's authorized network communication and inter…
- [[NIST/ID.AM-04|ID.AM-04]]: Inventories of services provided by suppliers are maintained
- [[NIST/ID.AM-05|ID.AM-05]]: Assets are prioritized based on classification, criticality, resources, and impa…
- [[NIST/ID.AM-07|ID.AM-07]]: Inventories of data and corresponding metadata for designated data types are mai…
- [[NIST/ID.AM-08|ID.AM-08]]: Systems, hardware, software, services, and data are managed throughout their lif…
- [[NIST/ID.IM-03|ID.IM-03]]: Improvements are identified from execution of operational processes, procedures,…
- [[NIST/PR.AA-01|PR.AA-01]]: Identities and credentials for authorized users, services, and hardware are mana…
- [[NIST/PR.AA-02|PR.AA-02]]: Identities are proofed and bound to credentials based on the context of interact…
- [[NIST/PR.AA-03|PR.AA-03]]: Users, services, and hardware are authenticated
- [[NIST/PR.AA-04|PR.AA-04]]: Identity assertions are protected, conveyed, and verified
- [[NIST/PR.AA-05|PR.AA-05]]: Access permissions, entitlements, and authorizations are defined in a policy, ma…
- [[NIST/PR.AA-06|PR.AA-06]]: Physical access to assets is managed, monitored, and enforced commensurate with …
- [[NIST/PR.DS-01|PR.DS-01]]: The confidentiality, integrity, and availability of data-at-rest are protected
- [[NIST/PR.DS-02|PR.DS-02]]: The confidentiality, integrity, and availability of data-in-transit are protecte…
- [[NIST/PR.DS-10|PR.DS-10]]: The confidentiality, integrity, and availability of data-in-use are protected
- [[NIST/PR.DS-11|PR.DS-11]]: Backups of data are created, protected, maintained, and tested
- [[NIST/PR.PS-01|PR.PS-01]]: Configuration management practices are established and applied
- [[NIST/PR.PS-02|PR.PS-02]]: Software is maintained, replaced, and removed commensurate with risk
- [[NIST/PR.PS-03|PR.PS-03]]: Hardware is maintained, replaced, and removed commensurate with risk
- [[NIST/PR.PS-04|PR.PS-04]]: Log records are generated and made available for continuous monitoring
- [[NIST/PR.PS-05|PR.PS-05]]: Installation and execution of unauthorized software are prevented
- [[NIST/PR.PS-06|PR.PS-06]]: Secure software development practices are integrated, and their performance is m…
- [[NIST/RC.CO-03|RC.CO-03]]: Recovery activities and progress in restoring operational capabilities are commu…
- [[NIST/RC.RP-01|RC.RP-01]]: The recovery portion of the incident response plan is executed once initiated fr…
- [[NIST/RC.RP-02|RC.RP-02]]: Recovery actions are selected, scoped, prioritized, and performed
- [[NIST/RC.RP-03|RC.RP-03]]: The integrity of backups and other restoration assets is verified before using t…
- [[NIST/RC.RP-04|RC.RP-04]]: Critical mission functions and cybersecurity risk management are considered to e…
- [[NIST/RC.RP-05|RC.RP-05]]: The integrity of restored assets is verified, systems and services are restored,…
- [[NIST/RC.RP-06|RC.RP-06]]: The end of incident recovery is declared based on criteria, and incident-related…
- [[NIST/RS.MA-01|RS.MA-01]]: The incident response plan is executed in coordination with relevant third parti…
- [[NIST/RS.MA-02|RS.MA-02]]: Incident reports are triaged and validated
- [[NIST/RS.MA-03|RS.MA-03]]: Incidents are categorized and prioritized
- [[NIST/RS.MA-04|RS.MA-04]]: Incidents are escalated or elevated as needed
- [[NIST/RS.MA-05|RS.MA-05]]: The criteria for initiating incident recovery are applied
- [[NIST/RS.MI-01|RS.MI-01]]: Incidents are contained
- [[NIST/RS.MI-02|RS.MI-02]]: Incidents are eradicated
...
[[NICE/000 NICE Framework v2.2.0|NICE Framework v2.2.0]]
